...
export function getReactInstanceForElement(element: EventTarget): Instance | undefined {
  ...
  if ("_reactRootContainer" in element) {
    // @ts-expect-error - TS2339 - Property '_reactRootContainer' does not exist on type 'EventTarget'.
